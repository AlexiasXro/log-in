              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  ...
                  <h4 class="mt-1 mb-5 pb-1">Registrate</h4>
                    ...
                    <form method="POST" action="{{route('register.registation')}}">
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                          <label class="form-label" for="">Correo electrónico</label>
                            <input type="email" name="user" class="form-control" placeholder="Ingrese su correo electronico" />
                        </div>
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                          <label class="form-label" for="">Confirmar contraseña</label>
                            <input type="password" id="" name="confpsw" class="form-control" placeholder="Confirme su contraseña" />
                        </div>
